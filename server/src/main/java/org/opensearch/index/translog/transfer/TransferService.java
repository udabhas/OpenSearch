...
public interface TransferService {
     ...
     */
    void uploadBlob(final TransferFileSnapshot fileSnapshot, Iterable<String> remotePath, WritePriority writePriority, CryptoMetadata cryptoMetadata) throws IOException;
